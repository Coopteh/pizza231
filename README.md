## Задание -  инверсия зависимостей через интерфейс (абстракцию)  
...
> git checkout -b task-31-03-26-DInjection
```
Выполните задание по курсу "Разработка кода" на сайте prepodis.ru  
