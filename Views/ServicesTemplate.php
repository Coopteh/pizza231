...
class ServicesTemplate extends BaseTemplate
{
    public static function getTemplate(): string
    {
        ...
        .service-card::before { content: ""; position: absolute; top: 0; left: 0; width: 100%; height: 5px; background: linear-gradient(90deg, #0d6efd, #0dcaf0); }
        .icon-box { width: 85px; height: 85px; display: flex; align-items: center; justify-content: center; border-radius: 50%; font-size: 2.75rem; margin: 0 auto 1.5rem; background: linear-gradient(135deg, #eef2ff 0%, #f0f4ff 100%); color: #0d6efd; transition: all 0.3s ease; }
        .service-card:hover .icon-box { background: linear-gradient(135deg, #0d6efd 0%, #0dcaf0 100%); color: #ffffff; transform: scale(1.05); }
        ...
        .btn-custom { border-radius: 50px; padding: 10px 28px; font-weight: 500; transition: all 0.3s ease; border: 2px solid #0d6efd; color: #0d6efd; background: transparent; text-decoration: none; display: inline-block; font-size: 0.95rem; }
        .btn-custom:hover { background: #0d6efd; color: #ffffff; box-shadow: 0 6px 20px rgba(13, 110, 253, 0.25); text-decoration: none; }
        ...
        .calc-header { background: linear-gradient(135deg, #0d6efd 0%, #0dcaf0 100%); color: #ffffff; padding: 1.5rem 2rem; border-radius: 20px 20px 0 0; margin: -2.5rem -2.5rem 2rem; text-align: center; }
        ...
        .form-control:focus, .form-select:focus { border-color: #0d6efd; box-shadow: 0 0 0 4px rgba(13, 110, 253, 0.12); outline: none; }
        .form-check-input:checked { background-color: #0d6efd; border-color: #0d6efd; }
        .btn-calc { background: linear-gradient(135deg, #0d6efd 0%, #0dcaf0 100%); border: none; padding: 14px 32px; border-radius: 50px; color: #ffffff; font-weight: 600; font-size: 1rem; width: 100%; transition: all 0.3s ease; box-shadow: 0 6px 20px rgba(13, 110, 253, 0.25); }
        ...
        .result-value { font-size: 2.25rem; font-weight: 700; color: #0d6efd; line-height: 1.2; }
        ...
        .term-switch .form-check-input:checked + .form-check-label { background: #0d6efd; color: #ffffff; }
        ...
        .option-card:hover { border-color: #0d6efd; background: #f8fafc; }
        ...
        .divider { width: 70px; height: 4px; background: linear-gradient(90deg, #0d6efd, #0dcaf0); margin: 20px auto; border-radius: 2px; }
        </style>';
