            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-9">
                        ...
                        <div class="row g-0 h-100">
                            ...
                            <div class="col-md-7 col-lg-8">
                                <div class="card-body p-4 p-md-5 d-flex flex-column justify-content-center">
                                    <h5 class="text-uppercase text-secondary fw-bold ls-1 mb-2" style="font-size: 0.9rem;">Наше предложение</h5>
                                    ...
                                    <div class="mt-auto">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill">Сделаем без б</span>
                                        </div>
                    ...
                    <div class="row mt-4 text-center text-muted small">
                        <div class="col-4">
                            <i class="bi bi-truck me-1"></i> Быстро сделаем
                        </div>
                        <div class="col-4">
                            <i class="bi bi-shield-check me-1"></i> Гарантия качества
                        </div>
                        <div class="col-4">
                            <i class="bi bi-heart me-1"></i> Надежно
                        </div>
                    </div>
                </div>
            </div>
