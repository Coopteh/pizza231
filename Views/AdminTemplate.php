...
class AdminTemplate extends BaseTemplate
{
    private static function getStyles(): string
    {
        ...
        /* Sidebar - ЗАКРЕПЛЁННЫЙ И КРАСИВЫЙ */
        .admin-sidebar {
            width: 280px;
    ...
    public static function dashboard(array $products, array $users, array $orders, array $logs, array $stats): string
    {
        ...
        $title = 'Админ-панель — Чёрный Вантуз';
        ...
        <div class="admin-sidebar">
            <div class="admin-logo">
                ...
                <div class="admin-logo-text">Чёрный Вантуз</div>
            </div>
            <ul class="admin-nav">
    ...
    // ... остальные методы (logs, editProduct, addProduct, activateAdmin) остаются такими же ...
