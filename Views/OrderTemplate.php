...
class OrderTemplate extends BaseTemplate
{
    public static function render(array $basketItems = [], float $total = 0): string
    {
        ...
        $title = 'Оформление заказа — Страховая компания «Чёрный Вантуз»';
        ...
        if (!empty($_SESSION['flash'])) {
            ...
            $flashHtml = '<div class="alert '.$alertClass.' alert-dismissible fade show mb-4" role="alert">
                '.$flashMessage.'
        ...
        <style>
            ...
            .push-notification .icon-wrapper {
                width: 50px;
                height: 50px;
                border-radius: 14px;
        ...
        <div id="pushNotification" class="push-notification" role="alert">
            ...
            <div class="content">
                <div class="title">Заказ успешно создан!</div>
                <div class="message" id="pushMessage">
                    Ваш заказ передан в обработку. Документы будут отправлены выбранным способом.
                </div>
            </div>
        ...
        <section class="container py-5">
            <div class="order-form">
                ...
                <div class="form-summary">
                    <small class="text-muted d-block mb-2 fw-semibold">📋 Ваш заказ:</small>
                    '.$summaryHtml.'
                </div>
                ...
                <form action="/order" method="POST" id="orderForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-custom" id="fio" name="fio" 
                               placeholder="Иванов Иван Иванович" required>
                    </div>
                    
                    <div class="mb-3 field-wrapper">
                        <label class="form-label" id="contactLabel">Email для доставки *</label>
                        
                        <div id="addressField" class="field-slide hidden">
                            <input type="text" class="form-control form-control-custom" id="address" name="address" 
                                   placeholder="г. Москва, ул. Примерная, д. 1, кв. 1">
                            <small class="field-hint">🚚 Куда доставить документы курьером</small>
                        </div>
                        
                        <div id="emailField" class="field-slide visible">
                            <input type="email" class="form-control form-control-custom" id="email" name="email" 
                                   placeholder="example@mail.ru" required>
                            <small class="field-hint">📧 Куда отправить электронные полисы</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="form-label">📬 Способ получения документов:</label>
                        <div class="delivery-options">
                            <label class="delivery-option active" data-type="email">
                                <input type="radio" name="delivery_type" value="email" checked>
                                📧 Email
                            </label>
                            <label class="delivery-option" data-type="courier">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function toggleContactField() {
                if (emailRadio.checked) {
                    contactLabel.textContent = "Email для доставки *";
            ...
            form.addEventListener("submit", function(e) {
                ...
                // Сервер должен обработать и сделать редирект с ?success=1
            });
            
            // Проверяем URL на наличие параметра success
        ...
        function showPushNotification() {
            ...
            if (notification) {
                ...
                setTimeout(hidePushNotification, 6000);
            }
        }
